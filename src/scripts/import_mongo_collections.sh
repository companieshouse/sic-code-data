...
#
# Simple script to recreate your local Mongo Database using the json files created by the from a previous export script
#
...
import_json ons_combined_sic_activities.json
